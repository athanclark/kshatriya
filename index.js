          ...
          return function (pin) {
              ...
              if (Data_Eq.eq(GPIO.eqGPIOPin)(pin)(Kshatriya.toGPIOPin(Kshatriya.wheelSigGPIOPinAble)(Kshatriya.WheelSig.value))) {
                  return function __do() {
                      ...
                      if (v) {
                          if (v1.wheel.sensor instanceof LeftSensor) {
                              ...
                              if (v1.wheel.lastHit instanceof Data_Maybe.Just) {
                                  ...
                                  throw new Error("Failed pattern match at Main line 214, column 19 - line 232, column 46: " + [ v1.wheel.lastSpeed.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Main line 199, column 29 - line 232, column 46: " + [ v1.wheel.lastHit.constructor.name ]);
                          };
                          if (v1.wheel.sensor instanceof HitSensor) {
                              return Data_Unit.unit;
                          };
                          throw new Error("Failed pattern match at Main line 198, column 18 - line 233, column 37: " + [ v1.wheel.sensor.constructor.name ]);
                      };
                      if (v1.wheel.sensor instanceof LeftSensor) {
                          return Data_Unit.unit;
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 234, column 18 - line 237, column 70: " + [ v1.wheel.sensor.constructor.name ]);
                  };
              };
              if (Data_Boolean.otherwise) {
                  return Control_Monad_Eff_Console.log("!?!");
              };
              throw new Error("Failed pattern match at Main line 120, column 1 - line 239, column 11: " + [ dispatchWS.constructor.name, stateRef.constructor.name, pin.constructor.name ]);
          };
      };
  };
  var initialState = {
                              ...
                              return function __do() {
                                  ...
                                  (function () {
                                      ...
                                      if (meY instanceof Data_Maybe.Just) {
                                          ...
                                          throw new Error("Failed pattern match at Main line 55, column 24 - line 59, column 43: " + [ meY.value0.constructor.name ]);
                                      };
                                      throw new Error("Failed pattern match at Main line 53, column 11 - line 59, column 43: " + [ meY.constructor.name ]);
                                  })()();
